# Copyright (C) 2017 Jacob Barhak, Leandro Watanabe, Chris Myres 
# Copyright (C) 2013-2015 Jacob Barhak 
# Copyright (C) 2009-2012 The Regents of the University of Michigan
# This file is part of the SBML Arrays Examples. 
# The SBML Arrays Examples is free software: you can redistribute it and/or 
# modify it under the terms of the GNU Lesser General Public License as 
# published by the Free Software Foundation, either version 3 of the 
# License, or (at your option) any later version.
# The SBML Arrays Examples is distributed in the hope that it will be useful, 
# but WITHOUT ANY WARRANTY; without even the implied warranty of 
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
# See the GNU Lesser General Public License for more details.
# ADDITIONAL CLARIFICATION
# The SBML Arrays Examples is distributed in the hope that it will be 
...
# of the SBML Arrays Examples.
# The SBML Arrays Examples initially used examples derived from the 
...
# LGPL license.
# 
# The examples generated by this python script are simple abstract disease 
# models indented to be simulated using micro-simulation. This project is 
# therefore also called "Disease Models Using SBML Arrays" and hosted in the
# repository "DiseaseModelsSBML".
# Full description of these models can be found in the paper titled: 
# "Disease Models using the System Biology Markup Language (SBML)"
# This script generates SBML example files that can be uploaded to iBioSim
...
def DefineSBMLParam(Model, ID , IsConstant = None, Value = None, Units = None):
    " defines a parameter within amodel "
...
def InitExample(NumberToSimulate):
    " Initialze parameters including simulation size and repetitions "
    
    NameSpace = libsbml.SBMLNamespaces (3, 1, "arrays", 1)    
